...
function commercialPath({ origin = '', salesEmail = '', benchOrigin = '' } = {}) {
  ...
  return {
    ...
    description: 'The A2AParkBench public website links to the released free regression runner and public failure corpus. Private hosted workflows, customer entitlement, and paid CI remain gated.',
    planUrl: benchOrigin ? `${benchOrigin}/` : `${origin}/teams.html`,
    contact: salesEmail,
    paymentAvailable: false,
    note: 'The A2AParkBench public website is available, with links to the free regression runner and public failure corpus. Private team workflows and paid access remain gated; live checkout is not enabled.'
  };
}
