...
async function externalAction(url, payload) {
  if (process.env.NODE_ENV === 'production' && process.env.ALLOW_LOCAL_ADAPTERS !== 'true') throw new Error('External adapters are disabled on this deployment. Use browser participation instead.');
